export const ACTIONS = [
  { id: 'roomRecommend', label: '방 추천', prompt: '방 추천', aliases: ['방추천', '추천방', '인기방', '인기있는방보기'], related: ['tour', 'wishlist', 'summary'], mode: 'direct' },
...
export const STARTER_ACTION_IDS = ['roomRecommend', 'reserve', 'summary'];
