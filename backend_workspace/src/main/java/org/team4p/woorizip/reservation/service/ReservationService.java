...
public interface ReservationService {
	...
	int selectListCount(String userNo, String facilityNo); // 예약 목록 페이지 조회
	List<ReservationListResponseDTO> selectList(Pageable pageable, String userNo, String facilityNo); // 예약 목록 조회
	...
	ReservationStatsDTO analyzeReservation(String facilityNo); // 이용 통게 분석 데이터 조회
}
