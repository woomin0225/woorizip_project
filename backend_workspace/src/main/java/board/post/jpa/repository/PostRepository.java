package board.post.jpa.repository;
...
public interface PostRepository extends JpaRepository<PostEntity, Integer> {
  ...
  Page<PostEntity> findByBoardTypeNoAndPostTitleContainingIgnoreCaseOrderByPostNoDesc(
    String boardTypeNo,
    String keyword,
    Pageable pageable
  );
  ...
  Page<PostEntity> findByBoardTypeNoAndPostContentContainingIgnoreCaseOrderByPostNoDesc(
    String boardTypeNo,
    String keyword,
    Pageable pageable
  );
  ...
  //검색 - 날짜
  int countByBoardTypeNoAndPostCreatedAtBetween(
    String boardTypeNo, 
    LocalDateTime begin,
    LocalDateTime end);

  Page<PostEntity> findByBoardTypeNoAndPostCreatedAtBetweenOrderByPostNoDesc(
    String boardTypeNo,
    LocalDateTime begin,
    LocalDateTime end,
    Pageable pageable
