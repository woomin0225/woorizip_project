...
VALUES 
-- house1
('room1', '101호', 'house1', 'lessor1', 10000000, 500000, '월세', 30.50, '남향', '2026-03-01', '채광 좋은 남향 방', 1, 1, 1, 'ACTIVE', '에어컨,냉장고,세탁기', 3, 0, NULL),
('room2', '102호', 'house1', 'lessor1', 15000000, 600000, '월세', 35.00, '동향', '2026-03-15', '넓은 원룸',          1, 1, 1, 'ACTIVE', '침대,책상,옷장,WiFi',   2, 0, NULL),
-- house2
('room3', '201호', 'house2', 'lessor1', 50000000, NULL,   '전세', 45.00, '남향', '2026-04-01', '전세 귀한 매물',      2, 1, 1, 'ACTIVE', '',                    4, 0, NULL),
-- house3
('room4',  '301호', 'house3', 'lessor1', 10000000,  650000, '월세', 22.50, '남향',   '2026-03-03', '강서 네스트, 채광 좋은 남향 원룸', 1, 1, 1, 'ACTIVE', '에어컨,냉장고,세탁기', 3, 0, NULL),
('room5',  '502호', 'house3', 'lessor1', 20000000,  850000, '월세', 28.00, '동향',   '2026-03-10', '강서 네스트, 동향 1.5룸',          1, 1, 1, 'ACTIVE', '침대,책상,옷장,WiFi',   4, 0, NULL),
('room6',  '703호', 'house3', 'lessor1', 180000000, NULL,   '전세', 35.00, '남서향', '2026-04-01', '강서 네스트, 전세 매물',           2, 1, 1, 'ACTIVE', '',                    5, 0, NULL),
-- house4
('room7',  '201호', 'house4', 'lessor1',  8000000,  550000, '월세', 19.50, '북향',   '2026-03-05', '홍대 스테이, 실속형 원룸',         1, 1, 1, 'ACTIVE', '에어컨,세탁기',         2, 0, NULL),
('room8',  '302호', 'house4', 'lessor1', 12000000,  620000, '월세', 23.00, '남동향', '2026-03-20', '홍대 스테이, 남동향 채광',         1, 1, 1, 'ACTIVE', '냉장고,전자레인지',     3, 0, NULL),
('room9',  '401호', 'house4', 'lessor1', 15000000,  700000, '월세', 26.50, '서향',   '2026-04-10', '홍대 스테이, 투룸형',              2, 1, 0, 'ACTIVE', '침대,옷장,WiFi',        4, 0, NULL),
-- house5
('room10', '203호', 'house5', 'lessor1', 10000000,  600000, '월세', 20.00, '동향',   '2026-03-08', '종로 어반, 도심 직주근접',         1, 1, 1, 'ACTIVE', '에어컨,냉장고',         2, 0, NULL),
('room11', '505호', 'house5', 'lessor1', 30000000,  900000, '월세', 30.00, '남향',   '2026-03-25', '종로 어반, 남향 1.5룸',            1, 1, 1, 'ACTIVE', '침대,책상,옷장',         4, 0, NULL),
('room12', '801호', 'house5', 'lessor1', 220000000, NULL,   '전세', 38.00, '남동향', '2026-04-15', '종로 어반, 전세 매물',             2, 1, 1, 'ACTIVE', '',                    5, 0, NULL),
-- house6
('room13', '402호', 'house6', 'lessor1', 15000000,  800000, '월세', 24.00, '북서향', '2026-03-12', '용산 리버, 북서향 전망',           1, 1, 1, 'ACTIVE', '에어컨,세탁기,WiFi',     3, 0, NULL),
('room14', '706호', 'house6', 'lessor1', 25000000, 1000000, '월세', 32.00, '남향',   '2026-03-30', '용산 리버, 남향 투룸',             2, 1, 1, 'ACTIVE', '풀옵션(에어컨/냉장고/세탁기/침대)', 5, 0, NULL),
('room15', '1002호','house6', 'lessor1', 260000000, NULL,   '전세', 42.00, '남서향', '2026-04-20', '용산 리버, 전세 희소',             2, 2, 0, 'ACTIVE', '',                    6, 0, NULL),
-- house7
('room16', '101호', 'house7', 'lessor1',  7000000,  520000, '월세', 18.00, '북향',   '2026-03-02', '강동 메트로, 역세권 원룸',         1, 1, 1, 'ACTIVE', '에어컨',               1, 0, NULL),
('room17', '303호', 'house7', 'lessor1', 12000000,  650000, '월세', 23.50, '동향',   '2026-03-18', '강동 메트로, 동향 채광',           1, 1, 1, 'ACTIVE', '냉장고,세탁기',         3, 0, NULL),
('room18', '605호', 'house7', 'lessor1', 18000000,  750000, '월세', 27.00, '남동향', '2026-04-05', '강동 메트로, 1.5룸',               1, 1, 0, 'ACTIVE', '침대,책상,WiFi',         4, 0, NULL),
-- house8
('room19', '102호', 'house8', 'lessor1',  6000000,  450000, '월세', 17.50, '서향',   '2026-03-06', '노원 그린, 반려동물 가능',         1, 1, 1, 'ACTIVE', '세탁기',               2, 0, NULL),
('room20', '204호', 'house8', 'lessor1',  9000000,  520000, '월세', 20.00, '북동향', '2026-03-22', '노원 그린, 통풍 좋음',            1, 1, 1, 'ACTIVE', '냉장고,전자레인지',     2, 0, NULL),
('room21', '501호', 'house8', 'lessor1', 14000000,  600000, '월세', 24.00, '남향',   '2026-04-08', '노원 그린, 남향 채광',             1, 1, 0, 'ACTIVE', '에어컨,옷장',           3, 0, NULL),
-- house9
('room22', '201호', 'house9', 'lessor1',  8000000,  500000, '월세', 18.50, '북향',   '2026-03-04', '관악 메이트, 여성전용 원룸',       1, 1, 1, 'ACTIVE', 'WiFi',                2, 0, NULL),
('room23', '302호', 'house9', 'lessor1', 12000000,  580000, '월세', 21.50, '남동향', '2026-03-21', '관악 메이트, 스터디존 이용',       1, 1, 1, 'ACTIVE', '에어컨,책상',           3, 0, NULL),
('room24', '501호', 'house9', 'lessor1', 15000000,  650000, '월세', 25.00, '남향',   '2026-04-07', '관악 메이트, 남향 1.5룸',          1, 1, 0, 'ACTIVE', '침대,옷장',            4, 0, NULL),
-- house10
('room25', '301호', 'house10','lessor1', 10000000,  650000, '월세', 22.50, '남향',   '2026-03-03', '성수 커먼, 남향 원룸',             1, 1, 1, 'ACTIVE', '에어컨,세탁기',         3, 0, NULL),
('room26', '502호', 'house10','lessor1', 20000000,  850000, '월세', 28.00, '동향',   '2026-03-10', '성수 커먼, 동향 1.5룸',            1, 1, 1, 'ACTIVE', '침대,책상,WiFi',         4, 0, NULL),
('room27', '703호', 'house10','lessor1', 180000000, NULL,   '전세', 35.00, '남서향', '2026-04-01', '성수 커먼, 전세 매물',             2, 1, 1, 'ACTIVE', '',                    5, 0, NULL);
